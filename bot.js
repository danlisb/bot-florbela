...
let schedule = require('node-schedule'); // biblioteca para criar agendamentos
...
let arr = [
    ...
    'Sonho... que eu e tu, dois pobrezinhos, andamos de mãos dadas, nos caminhos duma terra de rosas, num jardim, num país de ilusão que nunca vi...',
    ...
    'Mas tive somente a mim, A minha absoluta verdade, Meu verdadeiro pensamento, O meu conforto nas horas de sofrimento, não vivo sozinha porque gosto, e sim porque aprendi a ser só...',
    ...
    'Bendita seja a Mãe que te gerou, Bendito o leite que te fez crescer. Bendito o berço aonde te embalou. A tua ama, pra te adormecer! Bendita essa canção que acalentou Da tua vida o doce alvorecer ...',
    ...
    'Disseram-me hoje, assim, ao ver-me triste: “Parece Sexta-Feira de Paixão. Sempre a cismar, cismar de olhos no chão, Sempre a pensar na dor que não existe... O que é que tem?! Tão nova e sempre triste! Faça por estar contente! Pois então?!...”',
    ...
    'Dissesse ela o que sente! Ai quem me dera!... Os males de Anto toda a gente os sabe! Os meus... ninguém... A minha Dor não cabe Nos cem milhões de versos que eu fizera!...',
    ...
    'Sou um verme que um dia quis ser astro... Uma chaga sangrenta do Senhor... Sei lá quem sou?! Sei lá! Cumprindo os fados, Num mundo de vaidades e pecados, Sou mais um mau, sou mais um pecador...',
...
// posta o que esta depois do 'status:' 
/*
...
// agendamento dos nossos tweets
let agendamento = schedule.scheduleJob('0 0 0/3 1/1 * ? *', function () {
